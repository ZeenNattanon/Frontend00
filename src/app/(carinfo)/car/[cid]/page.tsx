    ...
    return (
        <main className="text-center p-5">
            ...
            <div className='flex flex-row my-5'>
                <Image src={carDetail.data.picture} alt="Product Picture" width={0} height={0} sizes="100vw"
                ...
                <div className='text-md mx-5 text-left'>
                    ...
                    <Link href={`/reservations?id=${params.cid}&model=${carDetail.data.model}`}>
                        <button className="block rounded-md bg-sky-600 hover:bg-indigo-600 px-3 py-2 text-white shadow-sm mx-5 my-2">
                            Make Reservation
                        </button>
                    </Link>
                </div>
